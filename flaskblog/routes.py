...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your account has been created. You can now log in {form.username.data}!','success')
...
if you did not make request please ignore
    '''
    mail.send(msg)
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your password has been updated. You can now log in {form.username.data}!','success')
        return redirect(url_for('login'))
